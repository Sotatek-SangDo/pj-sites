...
if( ! function_exists( 'bs_better_translations_send_translations_cb' ) ){
	/**
	 * Callback for BetterTranslation Send translation custom field
	 *
	 * @since 1.0.3
	 */
	function bs_better_translations_send_translations_cb() {
		?>
		<div class="bf-translation-header bf-columns-2 bf-clearfix">
			<div class="bf-column bf-first-column">
				...
				<p>
					Select pre translations from following dropdown also if your language is not available you can translate
				...
				<div class="bf-column-container">
					<div class="typo-field-container bf-fullwidth-dropdown" style="width: 100%;">
						<select name="name" id="better-framework-pre-translations">
							...
							if( $translations = Better_Translation::factory()->get_translations() ) {
								$current_panel_lang = get_option( Better_Translation::factory()->option_panel_id . bf_get_current_language_option_code() . '-current' );
			...
			<div class="bf-column bf-second-column">
				...
				<a id="better-translation-send" class="button-large bf-button bf-main-button"> Send Translation </a>
				<script>
		...
		<?php
	} // bs_better_translations_send_translations_cb
}
