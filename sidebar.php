...
<aside <?php better_attr( 'sidebar', 'col-lg-4 col-md-4 col-sm-4 col-xs-12 main-sidebar ' . ( Better_Mag::current_sidebar_layout() == 'right' ? 'vertical-left-line' : 'vertical-right-line' ), 'primary-sidebar' ) ?>>
