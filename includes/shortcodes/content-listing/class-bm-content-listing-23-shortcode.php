<?php
/**
 * BetterMag Content Listing 23
 */
class BM_Content_Listing_23_Shortcode extends BM_Listing_Shortcode{

    function __construct(  ){

        $id = 'bm_content_listing_23';

        $this->name = __( 'Content Listing 23', 'better-studio');

        $this->description = __( '1 Column', 'better-studio' );

        $this->icon = ( BETTER_MAG_ADMIN_ASSETS_URI . 'images/vc-bm_content_listing_22.png' );
    ...
    function display( array $atts  , $content = '' ){
        ...
        ?>
        <div class="row block-listing block-listing-23">
...
class WPBakeryShortCode_bm_content_listing_23 extends BM_VC_Shortcode_Extender { }