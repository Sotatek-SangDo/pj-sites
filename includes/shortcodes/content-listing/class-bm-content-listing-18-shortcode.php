    ...
    function display( array $atts  , $content = '' ){
        ...
        <div class="row block-listing block-listing-18">
            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 block-listing-part-1"><?php
                ...
                if( $atts['post_type1'] ){
                    $args['post_type'] = explode( ',', $atts['post_type1'] );
                }
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 block-listing-part-2"><?php
                ...
                if( $atts['post_type2'] ){
                    $args['post_type'] = explode( ',', $atts['post_type2'] );
                }
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 block-listing-part-3"><?php
                ...
                if( $atts['post_type3'] ){
                    $args['post_type'] = explode( ',', $atts['post_type3'] );
                }
        ...
        vc_map( array(
            ...
            "params"    => array(
                ...
                array(
                    "type"          => 'textfield',
                    "admin_label"   => true,
                    "heading"       => __( 'Column 1 Custom Post Type', 'better-studio' ),
                    "param_name"    => 'post_type1',
                    "value"         => $this->defaults['post_type1'],
                ),
                array(
                    "type"          =>  'bf_switchery',
                ...
                array(
                    "type"          => 'textfield',
                    "admin_label"   => true,
                    "heading"       => __( 'Column 2 Custom Post Type', 'better-studio' ),
                    "param_name"    => 'post_type2',
                    "value"         => $this->defaults['post_type2'],
                ),
                array(
                    "type"          =>  'bf_switchery',
                    "heading"       =>  __( 'Show read more button?', 'better-studio' ),
                ...
                array(
                    "type"          => 'textfield',
                    "admin_label"   => true,
                    "heading"       => __( 'Column 3 Custom Post Type', 'better-studio' ),
                    "param_name"    => 'post_type3',
                    "value"         => $this->defaults['post_type3'],
                ),
                array(
                    "type"          =>  'bf_switchery',
                    "heading"       =>  __( 'Show read more button?', 'better-studio' ),
